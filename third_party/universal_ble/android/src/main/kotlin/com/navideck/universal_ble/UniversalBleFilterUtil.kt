...
class UniversalBleFilterUtil {
    ...
    fun usesCustomFilters(scanFilter: UniversalScanFilter): Boolean {
        return scanFilter.usesCustomFilters()
    }

    fun toScanFilters(scanFilter: UniversalScanFilter, serviceUuids: List<UUID>): List<ScanFilter> {
        return scanFilter.toScanFilters(serviceUuids)
    }
