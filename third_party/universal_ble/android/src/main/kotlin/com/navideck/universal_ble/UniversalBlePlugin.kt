...
class UniversalBlePlugin : UniversalBlePlatformChannel, BluetoothGattCallback(), FlutterPlugin,
    ...
    override fun onDetachedFromEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        UniversalBleShutdown.disconnectAll("plugin detached from engine")
    ...
    override fun startScan(filter: UniversalScanFilter?) {
        ...
        val usesCustomFilters = filter?.let { universalBleFilterUtil.usesCustomFilters(it) } ?: false
        ...
        try {
            ...
            if (usesCustomFilters) {
                ...
                scanFilters = filter?.let {
                    universalBleFilterUtil.toScanFilters(it, filterServices)
                } ?: emptyList()
            }
    ...
    private fun cleanConnection(gatt: BluetoothGatt) {
        gatt.removeCache()
        gatt.disconnectAndClose("clean connection")
    ...
    override fun onDetachedFromActivity() {
        UniversalBleShutdown.disconnectAll("activity detached")
        activity = null
